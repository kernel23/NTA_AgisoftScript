...
root_dir = sys.argv[1] # 
output_TIF = root_dir + 'TIF'
output_KMZ = root_dir + 'KMZ'
...
for dir_with_jpg in dirs_with_jpg:
    ...
    doc.save(os.path.join(output_project_folder, 'project.psx'))  # Saves the new Document, Usually the name of project is the name of the photos folder
